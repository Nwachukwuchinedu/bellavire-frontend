...
const Career = () => {
	...
	return (
		<div>
			...
			<div className="relative px-4 py-10 sm:py-16 md:py-20">
				<div className="max-w-6xl mx-auto relative">
					<div className="hidden md:block">
						...
						<div className="absolute top-0 -left-16 w-40 h-20 lg:w-60 lg:h-24 rounded-2xl overflow-hidden shadow-lg">
							<img
								src="/image1.png"
						...
						<div className="absolute top-24 -right-12	 w-40 h-20 lg:w-60 lg:h-24 rounded-2xl overflow-hidden shadow-lg">
							<img
								src="/image2.png"
						...
						<div className="absolute bottom-24 -left-20 w-40 h-20 lg:w-60 lg:h-24 rounded-2xl overflow-hidden shadow-lg">
							<img
								src="/image3.png"
			...
			{/* why work with us? */}
			<div className="bg-gray-100 flex flex-col items-center justify-center py-16 px-6 sm:px-12 lg:px-24">
			...
			{/* job opening */}
			<div className="mx-auto px-2 sm:px-4 lg:px-24 py-12 space-y-8">
			...
			{/* send us your cv */}
			<div className="py-16  sm:px-4 md:px-6 lg:px-24 bg-gray-100 min-h-screen">
				<Card className="shadow-lg mx-auto">
					<CardHeader className="text-center pb-6">
						...
						<h1 className="text-4xl font-medium leading-10">
						...
						<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<div className="space-y-2">
									<Label htmlFor="fullAddress" className="font-normal text-lg">
										Full Address
									</Label>
									<Input
										id="fullAddress"
								...
								{/* Email Address */}
								<div className="space-y-2">
									<Label htmlFor="emailAddress" className="font-normal text-lg">
										Email Address
									</Label>
									<Input
										id="emailAddress"
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								{/* Phone Number */}
								<div className="space-y-2">
									<Label htmlFor="phoneNumber" className="font-normal text-lg">
										Phone Number
									</Label>
									<div className="flex">
										<select
											{...register('countryCode')}
											className="h-16 border-2 border-r-0 border-gray-400  rounded-l-md px-3 text-sm"
										>
										...
										<Input
											id="phoneNumber"
											className={`rounded-l-none h-16 w-full ${
												errors.phoneNumber
													? 'border-red-500'
													: 'border-gray-400'
											} border-2`}
								...
								{/* Position */}
								<div className="space-y-2">
									<Label htmlFor="position" className="font-normal text-lg">
										Position
									</Label>
									<Controller
										name="position"
							...
							{/* CV Upload */}
							<div className="space-y-2">
								<Label htmlFor="cv" className="font-normal text-lg">
									CV
								</Label>
								<div
									className={`border-2  rounded-lg p-6 text-center h-28 ${
								...
								>
									...
									<label
										htmlFor="cv"
										className="cursor-pointer flex flex-col items-center space-y-"
									>
										<Upload className="h-8 w-8" />
										<h1 className="bg-secondary text-white hover:bg-secondary hover:text-white p-2 rounded-md">
											Upload File
										</h1>
							...
							<Button
								type="submit"
								className="w-full bg-secondary hover:bg-secondary text-white py-8"
